...
export async function create(this: IExecuteFunctions, index: number): Promise<INodeExecutionData[]> {
	...
	const responseData = await easybillApiRequest.call(this, 'POST', '/discounts/position', { body });
...
export async function update(this: IExecuteFunctions, index: number): Promise<INodeExecutionData[]> {
	...
	const responseData = await easybillApiRequest.call(this, 'PUT', `/discounts/position/${id}`, { body });
	return this.helpers.returnJsonArray(responseData);
}

export async function get(this: IExecuteFunctions, index: number): Promise<INodeExecutionData[]> {
	const id = this.getNodeParameter('id', index) as number;
	const responseData = await easybillApiRequest.call(this, 'GET', `/discounts/position/${id}`);
	return this.helpers.returnJsonArray(responseData);
}
...
export async function getAll(this: IExecuteFunctions, index: number): Promise<INodeExecutionData[]> {
	...
	const responseData = await easybillApiRequest.call(this, 'GET', '/discounts/position', { qs });
	return this.helpers.returnJsonArray(responseData.items);
}

export async function del(this: IExecuteFunctions, index: number): Promise<INodeExecutionData[]> {
	const id = this.getNodeParameter('id', index) as number;
	await easybillApiRequest.call(this, 'DELETE', `/discounts/position/${id}`);
