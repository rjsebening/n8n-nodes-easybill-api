	...
	// Send Additional Fields
	{
		...
		options: [
			...
			},
			{
				...
				type: 'string',
				default: '',
				description: 'Date of sending (RFC 3339 full-date, e.g. 2017-07-21)',
			},
			{
				...
				type: 'options',
				default: 'default',
				description: 'File format of the document. If empty, customer default is used.',
				options: [
			...
			},
			{
				...
				description: 'Postal dispatch type (only relevant when sending via POST)',
				options: [
					{ name: 'Registered', value: 'post_send_type_registered' },
					{ name: 'Registered + Personal', value: 'post_send_type_registered_and_personal' },
					{ name: 'Registered + Receipt', value: 'post_send_type_registered_and_receipt' },
					{ name: 'Registered + Throw-In', value: 'post_send_type_registered_throwin' },
					{ name: 'Standard', value: 'post_send_type_standard' },
				],
			},
			{
				displayName: 'Send Copy to Yourself',
				name: 'send_by_self',
				type: 'boolean',
				default: false,
				description: 'Whether to send a copy of the email to yourself',
			},
			{
				...
				type: 'boolean',
				default: true,
				description: 'Whether the document is attached to the email',
			},
			{
				displayName: 'Subject',
				name: 'subject',
